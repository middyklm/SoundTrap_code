...
typedef  void (*DMA_Isr)(int channel);

#define SDCARD_DMA_READ_CHANNEL CSL_DMA_CHAN0
#define SDCARD_DMA_WRITE_CHANNEL CSL_DMA_CHAN1
//#define ADC_DMA_CHANNEL CSL_DMA_CHAN12
//#define AUDIO_MEMCPY_DMA_CHANNEL CSL_DMA_CHAN13 //on same DMA controler as ADC_DMA
#define AUDIO_TX_DMA_CHANNEL CSL_DMA_CHAN14 //on same DMA controler as ADC_DMA
