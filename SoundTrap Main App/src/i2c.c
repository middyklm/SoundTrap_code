...
int i2cRead(Uint16 slaveAddress, Uint16 *buf, Uint16 count, Uint16 timeout)
{
	Uint16 i;
	if((buf != NULL) && (count != 0))
	{
		if( i2cWaitForBus( timeout ) == OK) {
...
int i2cWrite(Uint16 slaveAddress, Uint16 *buf, Uint16 count, Uint16 timeout)
{
	Uint16 i;
	if((buf != NULL))// && (count != 0))
	{
...
int i2cWriteRead(Uint16 slaveAddress, Uint16 *outBuf, Uint16 outCount, Uint16 *inBuf, Uint16 inCount, Uint16 timeout)
{
	Uint16 i;
	if(outBuf != NULL)
	{
