                       ...
                       Uint16             waitForRsp)
{
    ...
    else
	{
		...
		mmcTorValue = hMmcsd->mmcRegs->MMCTOR;
        hMmcsd->mmcRegs->MMCTOR  = waitForRsp;
        ...
        do
        {
			...
			if((status & CSL_MMCSD_CMD_TOUT_CRC_ERROR) != 0)
			{
				...
				{
					hMmcsd->mmcRegs->MMCTOR = mmcTorValue;
 ...
 *  ===========================================================================
 */
CSL_Status MMC_sendRca(CSL_MmcsdHandle     hMmcsd,
